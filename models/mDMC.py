    ...
    def __init__(self, data=None, input_data_id="PPT", input_data_congruency="Condition", input_data_rt="RT", input_data_accuracy="Correct"):
        ...
        if data != None:
            if isinstance(data, str): 
                ...
                self.data = data
            self.bounds = [(0.07,0.38),(0,1),(-1, 1),(-5, 5),(1.5,4.5),(0.02,0.12),(0.015,0.4),(0.15,min(self.data['rt']))]
        else: 
            self.bounds = [(0.07,0.38),(0,1),(-1, 1),(-5, 5),(1.5,4.5),(0.02,0.12),(0.015,0.4),(0.15,0.45)]
